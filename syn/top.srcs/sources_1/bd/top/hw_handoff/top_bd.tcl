...
proc create_root_design { parentCell } {
  ...
  # Create instance: sha256_ctrl_axi, and set properties
  set sha256_ctrl_axi [ create_bd_cell -type ip -vlnv martina_fogliato:DS2018:sha256_ctrl_axi:1.0 sha256_ctrl_axi ]

  set_property -dict [ list \
   CONFIG.NUM_READ_OUTSTANDING {1} \
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /sha256_ctrl_axi/s0_axi]
  ...
  connect_bd_intf_net -intf_net ps7_axi_periph_M00_AXI [get_bd_intf_pins ps7_axi_periph/M00_AXI] [get_bd_intf_pins sha256_ctrl_axi/s0_axi]

  # Create port connections
  connect_bd_net -net ps7_FCLK_CLK0 [get_bd_pins ps7/FCLK_CLK0] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps7_axi_periph/ACLK] [get_bd_pins ps7_axi_periph/M00_ACLK] [get_bd_pins ps7_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_100M/slowest_sync_clk] [get_bd_pins sha256_ctrl_axi/aclk]
  ...
  connect_bd_net -net rst_ps7_100M_peripheral_aresetn [get_bd_pins ps7_axi_periph/M00_ARESETN] [get_bd_pins ps7_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_100M/peripheral_aresetn] [get_bd_pins sha256_ctrl_axi/aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs sha256_ctrl_axi/s0_axi/reg0] SEG_sha256_ctrl_axi_reg0
